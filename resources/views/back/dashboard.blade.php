                                        ...
                                        <div class="direct-chat-contacts">
                                            <ul class="contacts-list">
                                                <li>
                                                    <a href="#">
                                                        <img class="contacts-list-img"
                                                            src="/back/dist/img/user1-128x128.jpg" alt="User Avatar">
                                                ...
                                                <li>
                                                    <a href="#">
                                                        <img class="contacts-list-img"
                                                            src="/back/dist/img/user7-128x128.jpg" alt="User Avatar">
                                                ...
                                                <li>
                                                    <a href="#">
                                                        <img class="contacts-list-img"
                                                            src="/back/dist/img/user3-128x128.jpg" alt="User Avatar">
                                                ...
                                                <li>
                                                    <a href="#">
                                                        <img class="contacts-list-img"
                                                            src="/back/dist/img/user5-128x128.jpg" alt="User Avatar">
                                                ...
                                                <li>
                                                    <a href="#">
                                                        <img class="contacts-list-img"
                                                            src="/back/dist/img/user6-128x128.jpg" alt="User Avatar">
                                                ...
                                                <li>
                                                    <a href="#">
                                                        <img class="contacts-list-img"
                                                            src="/back/dist/img/user8-128x128.jpg" alt="User Avatar">
