...
<body class="dark-mode sidebar-mini layout-footer-fixed sidebar-mini-md sidebar-mini-xs layout-navbar-fixed">
    <div class="wrapper">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        <a href="#" class="dropdown-item">
                            <!-- Message Start -->
                            <div class="media">
                                <img src="/back/dist/img/user1-128x128.jpg" alt="User Avatar"
                        ...
                        <a href="#" class="dropdown-item">
                            <!-- Message Start -->
                            <div class="media">
                                <img src="/back/dist/img/user8-128x128.jpg" alt="User Avatar"
                        ...
                        <a href="#" class="dropdown-item">
                            <!-- Message Start -->
                            <div class="media">
                                <img src="/back/dist/img/user3-128x128.jpg" alt="User Avatar"
                                    class="img-size-50 img-circle mr-3">
                                <div class="media-body">
                                    <h3 class="dropdown-item-title">
                                        Nora Silvester
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4 sidebar-no-expand">
            ...
            <a href="index3.html" class="brand-link text-sm">
                <img src="/back/dist/img/AdminLTELogo.png" alt="AdminLTE Logo"
            ...
            <div class="sidebar">
                ...
                <!-- Sidebar Menu -->
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent nav-collapse-hide-child nav-compact nav-flat text-sm" data-widget="treeview" role="menu"
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="direct-chat-messages">
                                                ...
                                                <div class="direct-chat-msg">
                                                    ...
                                                    <!-- /.direct-chat-infos -->
                                                    <img class="direct-chat-img" src="/back/dist/img/user1-128x128.jpg"
                                                ...
                                                <div class="direct-chat-msg right">
                                                    ...
                                                    <!-- /.direct-chat-infos -->
                                                    <img class="direct-chat-img" src="/back/dist/img/user3-128x128.jpg"
                                                        alt="message user image">
                                                    <!-- /.direct-chat-img -->
                                                    <div class="direct-chat-text">
                                            ...
                                            <div class="direct-chat-contacts">
                                                <ul class="contacts-list">
                                                    <li>
                                                        <a href="#">
                                                            <img class="contacts-list-img"
                                                                src="/back/dist/img/user1-128x128.jpg"
                                                                alt="User Avatar">
                                                    ...
                                                    <li>
                                                        <a href="#">
                                                            <img class="contacts-list-img"
                                                                src="/back/dist/img/user7-128x128.jpg"
                                                                alt="User Avatar">
                                                    ...
                                                    <li>
                                                        <a href="#">
                                                            <img class="contacts-list-img"
                                                                src="/back/dist/img/user3-128x128.jpg"
                                                                alt="User Avatar">
                                                    ...
                                                    <li>
                                                        <a href="#">
                                                            <img class="contacts-list-img"
                                                                src="/back/dist/img/user5-128x128.jpg"
                                                                alt="User Avatar">
                                                    ...
                                                    <li>
                                                        <a href="#">
                                                            <img class="contacts-list-img"
                                                                src="/back/dist/img/user6-128x128.jpg"
                                                                alt="User Avatar">
                                                    ...
                                                    <li>
                                                        <a href="#">
                                                            <img class="contacts-list-img"
                                                                src="/back/dist/img/user8-128x128.jpg"
                                                                alt="User Avatar">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body p-0">
                                            <ul class="users-list clearfix">
                                                <li>
                                                    <img src="/back/dist/img/user1-128x128.jpg" alt="User Image">
                                                    <a class="users-list-name" href="#">Alexander Pierce</a>
                                                    <span class="users-list-date">Today</span>
                                                </li>
                                                <li>
                                                    <img src="/back/dist/img/user8-128x128.jpg" alt="User Image">
                                                    <a class="users-list-name" href="#">Norman</a>
                                                    <span class="users-list-date">Yesterday</span>
                                                </li>
                                                <li>
                                                    <img src="/back/dist/img/user7-128x128.jpg" alt="User Image">
                                                    <a class="users-list-name" href="#">Jane</a>
                                                    <span class="users-list-date">12 Jan</span>
                                                </li>
                                                <li>
                                                    <img src="/back/dist/img/user6-128x128.jpg" alt="User Image">
                                                    <a class="users-list-name" href="#">John</a>
                                                    <span class="users-list-date">12 Jan</span>
                                                </li>
                                                <li>
                                                    <img src="/back/dist/img/user2-160x160.jpg" alt="User Image">
                                                    <a class="users-list-name" href="#">Alexander</a>
                                                    <span class="users-list-date">13 Jan</span>
                                                </li>
                                                <li>
                                                    <img src="/back/dist/img/user5-128x128.jpg" alt="User Image">
                                                    <a class="users-list-name" href="#">Sarah</a>
                                                    <span class="users-list-date">14 Jan</span>
                                                </li>
                                                <li>
                                                    <img src="/back/dist/img/user4-128x128.jpg" alt="User Image">
                                                    <a class="users-list-name" href="#">Nora</a>
                                                    <span class="users-list-date">15 Jan</span>
                                                </li>
                                                <li>
                                                    <img src="/back/dist/img/user3-128x128.jpg" alt="User Image">
                                    ...
                                    <ul class="products-list product-list-in-card pl-2 pr-2">
                                        <li class="item">
                                            <div class="product-img">
                                                <img src="/back/dist/img/default-150x150.png" alt="Product Image"
                                                    class="img-size-50">
                                            </div>
    ...
    <!-- PAGE PLUGINS -->
    <!-- jQuery Mapael -->
    <script src="/back/plugins/jquery-mousewheel/jquery.mousewheel.js"></script>
    <script src="/back/plugins/raphael/raphael.min.js"></script>
    <script src="/back/plugins/jquery-mapael/jquery.mapael.min.js"></script>
    <script src="/back/plugins/jquery-mapael/maps/usa_states.min.js"></script>
    <!-- ChartJS -->
