...
<body class="sidebar-mini layout-footer-fixed sidebar-mini-md sidebar-mini-xs layout-navbar-fixed layout-fixed">
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-olive elevation-1 sidebar-no-expand">
            <!-- Brand Logo -->
            <a href="/dashboard" class="brand-link text-sm">
            ...
            <div class="sidebar">
                ...
                <!-- Sidebar Menu -->
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent nav-collapse-hide-child nav-compact nav-flat text-sm"
